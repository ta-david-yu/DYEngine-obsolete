...
void SandboxApplication::buildTutScene(IScene* scene)
{
...
void SandboxApplication::buildTestScene0(IScene* scene)
{
	//-------------Test Math Type-------------//
...
void SandboxApplication::buildTestScene1(IScene* scene)
{
	// prototype
